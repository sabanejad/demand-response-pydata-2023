...
\begin{frame}{Random samples of populations are studied to estimate treatment effects.}
  \begin{itemize}
    ...
    \indent $\implies$ analyses are done on a \textbf{population vs a unit}. The \textbf{larger the population}, the easier to robustly estimate treatment effects.
...
\begin{frame}{Additional Features: Two Levels of Discrete Socio-Economic Categories}
  \centering
...
\begin{frame}{The two groups were not biased geographically}
  \begin{figure}
    \centering
      \includegraphics[width=0.75\textwidth]{images/london-geo-breakdown.png}
...
\begin{frame}{Dimenstionality Analysis: Treatment \& Control Group Matrices}
  \begin{multicols}{2}
  $$
